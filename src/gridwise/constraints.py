...
Originally from Ashik/src/gridwise/constraints.py (a942e15).
Aurna and Pulok keep constraint application inline in their optimizer.py;
Ashik factored them out into this dedicated module so the optimizer stays
focused on math.
"""
