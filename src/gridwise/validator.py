...
This module is intentionally permissive: when in doubt it coerces the entry
to a safe `no_op` rather than crashing. Wrong `no_op` loses interpretation
points; invented rules can also break application points.
"""
