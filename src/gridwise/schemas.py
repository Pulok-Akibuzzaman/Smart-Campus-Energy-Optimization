...
Originally from Ashik/src/gridwise/schemas.py (a942e15).
Ashik's Pydantic models are the most thorough of the three: per-directive
adjustment models (SolarReductionAdjustment, MinimumBatteryReserveAdjustment,
NoChargeWindowAdjustment, …), Literal union for StructuredAdjustment, and
battery-validity model validator. Aurna and Pulok use simpler single-class
models; we keep Ashik's per-directive typing for the merge.
"""
