...
Originally from Ashik/src/gridwise/interpreter.py (a942e15).
Merged-in from Aurna: regex patterns were reviewed against
Aurna/app/llm_interpreter.py:_parse_time_window (132–175) and
offline_semantic_interpreter (178–293). Aurna's regex is more permissive
(silent coercion on bad input); we kept Ashik's stricter patterns. The
provider chain shape is Ashik's — Aurna has only one hosted provider at a
time, Pulok has Puku-as-primary.
"""
