...
LABEL version="1.0.0" \
      description="GridWise: BUP CSE Fest 2026 Smart Campus Energy Optimization" \
      maintainer="Team Ai-Will-Fix-It" \
      org.opencontainers.image.source="https://github.com/Pulok-Akibuzzaman/Smart-Campus-Energy-Optimization-Challenge-Team-Ai-Will-Fix-It" \
